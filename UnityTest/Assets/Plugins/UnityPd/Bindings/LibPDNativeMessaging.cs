...
namespace LibPDBinding
{
	...
	public static partial class LibPD
	{
        ...
        [DllImport("AudioPluginDemo", EntryPoint="libpd_set_printhook")]
		private static extern void set_printhook(LibPDPrintHook hook);
		
        [DllImport("AudioPluginDemo", EntryPoint="libpd_set_banghook")]
		private static extern  void set_banghook(LibPDBangHook hook) ;

        [DllImport("AudioPluginDemo", EntryPoint="libpd_set_floathook")]
		private static extern  void set_floathook(LibPDFloatHook hook) ;

        [DllImport("AudioPluginDemo", EntryPoint="libpd_set_symbolhook")]
		private static extern  void set_symbolhook(LibPDSymbolHook hook) ;
		
        [DllImport("AudioPluginDemo", EntryPoint="libpd_set_listhook")]
		private static extern  void set_listhook(LibPDListHook hook) ;
		
        [DllImport("AudioPluginDemo", EntryPoint="libpd_set_messagehook")]
		...
		[DllImport("AudioPluginDemo", EntryPoint="libpd_atom_is_float")]
		private static extern int atom_is_float(IntPtr a) ;

		[DllImport("AudioPluginDemo", EntryPoint="libpd_atom_is_symbol")]
		private static extern int atom_is_symbol(IntPtr a) ;

		[DllImport("AudioPluginDemo", EntryPoint="libpd_atom_get_float")]
		private static extern float atom_get_float(IntPtr a) ;

		[DllImport("AudioPluginDemo", EntryPoint="libpd_atom_get_symbol")]
		private static extern IntPtr atom_get_symbol(IntPtr a);
		
		[DllImport("AudioPluginDemo", EntryPoint="libpd_next_atom")]
		...
		[DllImport("AudioPluginDemo", EntryPoint="libpd_bind")]
		...
		[DllImport("AudioPluginDemo", EntryPoint="libpd_unbind")]
		...
		[DllImport("AudioPluginDemo", EntryPoint="libpd_bang")]
		...
		[DllImport("AudioPluginDemo", EntryPoint="libpd_float")]
		...
		[DllImport("AudioPluginDemo", EntryPoint="libpd_symbol")]
		...
		[DllImport("AudioPluginDemo", EntryPoint="libpd_start_message")]
		private static extern  int start_message(int max_length) ;

		[DllImport("AudioPluginDemo", EntryPoint="libpd_finish_message")]
		...
		[DllImport("AudioPluginDemo", EntryPoint="libpd_finish_list")]
		...
		[DllImport("AudioPluginDemo", EntryPoint="libpd_add_float")]
		private static extern  void add_float(float x) ;
		
		[DllImport("AudioPluginDemo", EntryPoint="libpd_add_symbol")]
