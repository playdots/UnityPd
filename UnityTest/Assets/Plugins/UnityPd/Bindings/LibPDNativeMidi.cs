...
namespace LibPDBinding
{
	public static partial class LibPD
	{
		...
		[DllImport("AudioPluginDemo", EntryPoint="libpd_noteon")]
		...
		[DllImport("AudioPluginDemo", EntryPoint="libpd_controlchange")]
		...
		[DllImport("AudioPluginDemo", EntryPoint="libpd_programchange")]
		...
		[DllImport("AudioPluginDemo", EntryPoint="libpd_pitchbend")]
		...
		[DllImport("AudioPluginDemo", EntryPoint="libpd_aftertouch")]
		...
		[DllImport("AudioPluginDemo", EntryPoint="libpd_polyaftertouch")]
		...
		[DllImport("AudioPluginDemo", EntryPoint="libpd_midibyte")]
		...
		[DllImport("AudioPluginDemo", EntryPoint="libpd_sysex")]
		...
		[DllImport("AudioPluginDemo", EntryPoint="libpd_sysrealtime")]
